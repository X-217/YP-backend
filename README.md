...
23) Попытаться удалить карточку с некорректным ID, контроль ошибок / выполнено, 404
...
29) Попытаться поставить дизлайк (снять чужой лайк) карточке, контроль ошибки/ выполнено, 403
